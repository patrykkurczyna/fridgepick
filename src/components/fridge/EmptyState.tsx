    ...
    <div className="text-center py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-600 mb-6">
          {isEmptyState && (
            <>
              Dodaj swoje pierwsze produkty, aby zacząć zarządzać lodówką 
              i planować posiłki na podstawie dostępnych składników.
            </>
          )}
          {isNoResults && (
            <>
              Spróbuj zmienić kryteria wyszukiwania lub dodaj nowe produkty 
              do swojej lodówki.
            </>
          )}
        </p>
        ...
        {isEmptyState && (
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              Dodawaj produkty z datami ważności, aby aplikacja mogła lepiej 
              rekomendować przepisy i pomagać w zarządzaniu żywnością.
            </p>
          </div>
        )}
      </div>
