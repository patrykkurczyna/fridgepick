...
export const Logo: React.FC<LogoProps> = ({
  ...
  return (
    ...
    >
      ...
      <desc id="fridgepickDesc">
        Minimalist logo combining a fridge outline with a checkmark and wordmark.
      </desc>
 ...
 */
export const LogoMark: React.FC<Omit<LogoProps, 'markOnly'>> = (props) => (
  <Logo {...props} markOnly={true} />
);
